...
set MIRROR_SITE=http://mirrors.sonic.net/cygwin/
...
:: Install cygwin
setup-x86_64.exe --no-admin --no-desktop --no-shortcuts --no-startmenu --quiet-mode --site %MIRROR_SITE% --root %CD%\cygwin64 --local-package-dir %CD%\cygwin-packages --packages %PACKAGES% 
